...
// v5.7.8w:不再推 GitHub,function 直接 return + Cache-Control 5 分钟
// 调用方式:
//   - 浏览器直接 fetch /.netlify/functions/fetch-3d(latest.js)
//   - cron-job.org 可选 backup
  ...
  try {
    ...
    return {
      ...
      headers: {
        ...
        'Cache-Control': 'public, max-age=300, must-revalidate',  // 5 分钟 CDN 缓存
